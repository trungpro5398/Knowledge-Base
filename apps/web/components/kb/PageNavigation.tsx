...
export function PageNavigation({
  ...
  return (
    <nav className="mt-12 grid gap-3 border-t pt-6 sm:grid-cols-2" aria-label={t("kbNav.ariaLabel")}>
      {previous ? (
        <Link
          href={`/kb/${spaceSlug}/${previous.path}`}
          className="group rounded-xl border p-4 transition-colors hover:border-primary/50 hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
      ...
      {next ? (
        <Link
          ...
          className="group rounded-xl border p-4 text-right transition-colors hover:border-primary/50 hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
